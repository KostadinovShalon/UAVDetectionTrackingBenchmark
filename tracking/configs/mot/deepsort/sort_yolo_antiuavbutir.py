...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file='../mmtracking/data/anti-uav/images/anti-uav-ir.json',
    ...
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file='../mmtracking/data/anti-uav/images/anti-uav-test-ir.json',
        img_prefix='../mmtracking/data/anti-uav/images/'
        ))
model = dict(
    type='DeepSORT',
    pretrains=dict(
        ...
        "/home2/lgfm95/drone/Strig-UAV-Project/anti-uav/YOLOv3/ir/latest.pth",
        reid=  # noqa: E251
