...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/data/drones/anti-uav/quick-images/anti-uav-rgb.json',
    ...
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file='/data/drones/anti-uav/quick-images/anti-uav-test-rgb.json',
        img_prefix='/data/drones/anti-uav/images/'
        ))
model = dict(
    type='DeepSORT',
	...
	"/data/Anti UAV/YOLOv3/rgb/latest.pth",
        reid=  # noqa: E251
