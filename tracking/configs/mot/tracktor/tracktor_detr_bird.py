_base_ = [
    '../../_base_/models/tracktor_detr_base.py',
    '../../_base_/datasets/drone_vs_bird_office.py',
...
model = dict(
    ...
    pretrains=dict(
        ...
        # "/hdd/PhD/drone/Strig-UAV-Project/drone-vs-bird/DETR/latest.pth",
        "/data/drones/DETRbirdlatest.pth",
        reid=  # noqa: E251
